    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #1751a5;">
      <div class="container">
        ...
        <a class="navbar-brand" target="_blank" href="https://mdbootstrap.com/docs/standard/">
          <img src=https://www.pens.ac.id/wp-content/uploads/2018/04/Logo-PENS-putih-e1522932523588.png height="35" alt="" loading="lazy"
        ...
        <div class="collapse navbar-collapse" id="navbarExample01">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="" rel="nofollow"
