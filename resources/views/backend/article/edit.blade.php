                ...
                <div class="grid grid-rows-3 grid-flow-col gap-4">
                    ...
                    <div class="row-span-2 col-span-2">
                        ...
                        <input type="text" name="thumbnail_url" id="thumbnail_url"
                            class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"value="{{ $article->thumbnail }}">
                    </div>
                    ...
                    <div class="row-span-2 col-span-2">
                        ...
                        <select id="user_id" name="user_id"
                            ...
                            <option value="1" @checked(true)>Admin</option>
