                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                @if ($article->status == 'draft')
                                                    <span
                                                        class="bg-gradient-to-tl from-slate-600 to-slate-300 px-3 text-xs rounded py-2.3 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Draft</span>
                                                @else
                                                    <span
                                                        class="bg-gradient-to-tl from-green-600 to-lime-400 px-3 text-xs rounded-1.8 py-2.3 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                                        Publish</span>
                                                @endif
                                            </td>
                                            <td
